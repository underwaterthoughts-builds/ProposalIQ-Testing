...
const SECTION_CONTRACTS = {
  ...
  qa: {
    ...
    description: 'Named QA methodology. Specific risks for THIS engagement. Concrete mitigations. Escalation process.',
    target_words: 500,
    snippet_use_cases: ['risk', 'governance'],
    required_content: [
    ...
    forbidden: ['Generic QA platitudes', 'Risks without paired mitigations'],
  },
  commercial: {
