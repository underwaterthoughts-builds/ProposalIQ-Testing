...
const SECTION_CONTRACTS = {
  ...
  commercial: {
    ...
    required_content: [
      ...
      'Day-rate basis if available from suggestedApproach (cite the role names and rates)',
    ...
    forbidden: ['Vague phrases like "tiered approach" without any number', 'Missing exclusions list', 'Quoting in a currency different from the RFP without acknowledgement', 'Quoting materially below the RFP\'s stated range without justification', 'Stating a timeline that exceeds rfpData.timeline_weeks (the Approach section already fits the RFP window; Commercial must match)'],
  },
  why_us: {
