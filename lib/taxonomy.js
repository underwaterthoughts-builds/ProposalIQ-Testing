...
const STRONG_HINTS = {
  client: {
    ...
    'Industrial & Manufacturing': [
      ...
      // Well-known companies that are often misclassified as tech/media
      // when they appear in film/creative/comms project names
      'airbus', 'boeing', 'bae systems', 'bae ', 'rolls-royce',
      'rolls royce', 'lockheed', 'raytheon', 'thales', 'leonardo',
      'general dynamics', 'northrop', 'safran', 'smiths group',
      'general electric', ' ge ', 'siemens', 'honeywell',
      'caterpillar', 'anglo american', 'rio tinto', 'bhp',
    ],
    'Technology, Media & Telecommunications': [
    ...
    'Transport, Logistics & Supply Chain': [
      ...
      // Airlines are transport, not TMT, even when buying tech/media
