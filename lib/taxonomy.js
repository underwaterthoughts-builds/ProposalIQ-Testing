...
const SERVICE_TAXONOMY = {
  'Advertising & Campaigns': [
    'B2B Campaigns', 'Brand Campaigns', 'Cause / Purpose Campaigns', 'Employer Brand Campaigns',
    'Integrated Campaigns', 'Launch Campaigns', 'Product / Service Campaigns',
    'Retail / Shopper Campaigns',
  ],
  'Content & Editorial': [
    'Case Studies', 'Content Series', 'Copywriting', 'Editorial Content', 'Long-form Content',
    'Scriptwriting', 'Speechwriting', 'White Papers / Reports',
  ],
  'Corporate & Internal Communications': [
    'Change Communications', 'Culture & Values Communications', 'Employee Engagement',
    'Employer Communications', 'Internal Communications', 'Investor / Stakeholder Communications',
    'Leadership Communications', 'Transformation Communications',
  ],
  'Creative Strategy & Brand': [
    'Audience / Proposition Development', 'Brand Identity', 'Brand Positioning', 'Brand Strategy',
    'Campaign Strategy', 'Communications Strategy', 'Content Strategy', 'Naming & Verbal Identity',
  ],
  'Design & Experience': [
    'Campaign Visual Systems', 'Exhibition / Experience Design', 'Graphic Design',
    'Information Design / Infographics', 'Motion Design', 'Presentation / Deck Design',
    'UX / UI Design', 'Website / Microsite Design',
  ],
  'Engineering & Technical': [
    'Civil & Structural Engineering', 'Energy Systems', 'Environmental Engineering',
    'Health & Safety', 'Infrastructure Design', 'Mechanical & Electrical Engineering',
    'Technical Assessment & Assurance',
  ],
  'Events & Experiential': [
    'Awards / Internal Events', 'Conferences / Summits', 'Experiential Campaigns',
    'Hybrid / Virtual Events', 'Launch Events', 'Live Events', 'Pop-Ups / Installations',
    'Roadshows',
  ],
  'Film, Video & Audio': [
    'Animation / Motion Graphics', 'Brand Film', 'CEO / Leadership Video', 'Corporate Film',
    'Documentary / Case Story', 'Event Film / Highlights', 'Podcast / Audio Content',
    'Social Video', 'TVC / Commercial',
  ],
  'Finance & Commercial': [
    'Accounting & Audit', 'Bid Pricing & Commercial Strategy', 'Business Valuation',
    'Commercial Due Diligence', 'Financial Advisory', 'Financial Modelling', 'Tax Advisory',
    'Treasury & Risk Management',
  ],
  'Legal & Regulatory': [
    'Contract Management', 'Dispute Resolution', 'Employment Law', 'Intellectual Property',
    'Legal Advisory', 'Policy & Public Affairs', 'Regulatory Compliance',
  ],
  'Management Consulting': [
    'Change Management', 'Cost Reduction', 'Governance & Compliance', 'Operating Model Design',
    'Organisational Design', 'Performance Improvement', 'Post-Merger Integration',
    'Turnaround & Restructuring',
  ],
  'PR & Media Relations': [
    'Consumer PR', 'Corporate PR', 'Crisis Communications', 'Executive Profiling',
    'Issues Management', 'Media Relations', 'Press Office / Always-On PR', 'Reputation Management',
    'Thought Leadership',
  ],
  'People & Organisational Development': [
    'Culture & Engagement', 'Diversity & Inclusion', 'HR Strategy', 'Leadership Coaching',
    'Learning & Development', 'Reward & Benefits', 'Talent Management', 'Workforce Planning',
  ],
  'Programme & Project Management': [
    'Agile Delivery', 'Construction Management', 'Infrastructure Delivery', 'PMO Setup & Support',
    'Procurement & Contract Management', 'Programme Management', 'Project Management',
  ],
  'Research, Insights & Planning': [
    'Audience Research', 'Brand Tracking', 'Communications Measurement', 'Competitive Analysis',
    'Media / Content Audit', 'Message Testing', 'Stakeholder Mapping', 'Trend / Cultural Insight',
  ],
  'Social & Digital Content': [
    'Community Management', 'Digital Content Campaigns', 'Email / CRM Content',
    'Influencer / Creator Partnerships', 'Organic Social Content', 'Paid Social Content',
    'Social Media Strategy', 'Web / Landing Page Content',
  ],
  'Strategy & Advisory': [
    'Business Case Development', 'Business Strategy', 'Competitive Intelligence',
    'Corporate Strategy', 'Feasibility Studies', 'Growth Strategy', 'Market Entry Strategy',
    'Strategic Planning',
  ],
  'Sustainability & ESG': [
    'ESG Strategy', 'Environmental Assessment', 'Impact Measurement', 'Net Zero Planning',
    'Responsible Procurement', 'Social Value', 'Sustainability Reporting',
  ],
  'Technology & Digital': [
    'AI & Automation', 'Cloud Migration', 'Cybersecurity', 'Data & Analytics',
    'Digital Transformation', 'IT Strategy & Architecture', 'Product Development',
...
const CLIENT_TAXONOMY = {
  'Consumer & Retail': [
    ...
    'Food & Beverage Manufacturing', 'Grocery Retail', 'Luxury Goods', 'Specialty Retail',
  ],
  'Education': [
    'Corporate Learning & Development', 'EdTech', 'Education Policy & Regulation',
    'Higher Education', 'K-12 Education', 'Vocational & Technical Training',
  ],
  'Energy, Utilities & Resources': [
    'Energy Trading & Retail', 'Mining & Metals', 'Oil & Gas (Upstream / Midstream / Downstream)',
    'Power Generation', 'Renewables (Solar, Wind, Hydrogen)', 'Transmission & Distribution',
    'Water & Wastewater',
  ],
  'Financial Services': [
    'Asset & Wealth Management', 'Capital Markets Infrastructure',
    'Corporate & Investment Banking', 'FinTech', 'Insurance', 'Payments', 'Retail Banking',
  ],
  'Government & Public Sector': [
    'Central Government', 'Defence & Security', 'International Development',
    'Justice & Public Safety', 'Local / Municipal Government', 'Public Finance & Treasury',
    'Smart Cities & Urban Development',
  ],
  'Healthcare & Life Sciences': [
    'Biotechnology', 'Digital Health', 'Health Insurance / Payers', 'Hospitals & Health Systems',
    'Medical Devices', 'Pharmaceuticals', 'Public Health & Policy',
  ],
  'Hospitality, Travel & Tourism': [
    'Airlines (Commercial)', 'Cruise Lines', 'Events & Entertainment Venues', 'Hotels & Resorts',
    'Theme Parks & Attractions', 'Travel & Tourism Operators',
  ],
  'Industrial & Manufacturing': [
    'Advanced Manufacturing / Industry 4.0', 'Aerospace & Defence Manufacturing', 'Automotive',
    'Chemicals', 'Construction Materials', 'Electronics Manufacturing',
    'Industrial Equipment & Machinery',
  ],
  'Professional & Business Services': [
    'Accounting & Audit', 'Consulting Services', 'HR & Recruitment Services', 'Legal Services',
    'Marketing & Advertising', 'Outsourcing / BPO / Shared Services',
  ],
  'Real Estate & Infrastructure': [
    'Commercial Real Estate', 'Facilities Management', 'Infrastructure Development',
    'Property Investment & REITs', 'Residential Real Estate', 'Smart Infrastructure',
    'Urban Regeneration',
  ],
  ...
  'Transport, Logistics & Supply Chain': [
    'Aviation', 'Logistics & Freight', 'Maritime & Ports', 'Mobility Services', 'Postal Services',
    'Rail', 'Warehousing & Distribution',
  ],
  'Technology, Media & Telecommunications': [
    'Software & SaaS', 'IT Services', 'Telecommunications', 'Media & Broadcasting', 'Gaming',
    'Cloud & Infrastructure', 'Data & AI Platforms',
  ],
};
