            ...
            {activeTab === 'ai' && (
              <div className="max-w-2xl mx-auto space-y-5">
                <div className="bg-surface-container-low p-6">
                  ...
                  <div className="font-label text-[10px] uppercase tracking-widest text-primary mt-6 mb-3">Claude — In-app assistant (chat &amp; tool use)</div>
                  {[
                    ['API Key', info.has_claude ? 'Configured' : 'Not set — Assistant tab + widget will be inactive', info.has_claude ? '#6ab187' : '#9b8e80'],
                  ...
                  <p className="text-[11px] mt-2 text-on-surface-variant/70 leading-relaxed">
                    When set, the Assistant tab and floating widget can answer questions about your repository, scans, team, and clients. Without it, both surfaces show a setup message but the rest of ProposalIQ runs unchanged.
                  </p>

                  <p className="text-xs mt-4 text-on-surface-variant/70 leading-relaxed">
                    Set API keys in Railway → Variables tab. Use OPENAI_MODEL, GEMINI_MODEL, or CLAUDE_MODEL to override model names.
                  </p>
                </div>
              </div>
            )}
